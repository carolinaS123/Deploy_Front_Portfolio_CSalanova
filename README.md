Portfolio_CSalanova_Deploy_Frontend
...
:bangbang::warning: La app Web es lenta por favor tenga paciencia ya que la base de datos de la misma se encuentra alojada en una cuenta no paga ya que es un proyecto educativo, desde ya muchas gracias!:blush:
